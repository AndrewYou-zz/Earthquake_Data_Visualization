			...
			for(Marker quakeMarker: quakeMarkers){
				for(Marker cityMarker: cityMarkers){
					if(quakeMarker.isInside(map, mouseX, mouseY)){
						...
						Marker chosenEarthquake = quakeMarker; 
						if(quakeMarker.getDistanceTo(cityMarker.getLocation()) < ((EarthquakeMarker) quakeMarker).threatCircle()){
							cityMarker.setHidden(false); 
						}
						else{
							cityMarker.setHidden(true);
						}
						for(Marker quakeMarker2: quakeMarkers){
							if(quakeMarker2 != chosenEarthquake){
								quakeMarker2.setHidden(true);
							}
						}
					}
					else if(cityMarker.isInside(map, mouseX, mouseY)){
						lastClicked = (CommonMarker) cityMarker;  
						Marker chosenCity = cityMarker; 
						cityMarker.setHidden(false); 
						if(quakeMarker.getDistanceTo(cityMarker.getLocation()) < ((EarthquakeMarker) quakeMarker).threatCircle()){
							quakeMarker.setHidden(false); 
						}
						...
						for(Marker cityMarker2: cityMarkers){
							if(cityMarker2 != chosenCity){
								cityMarker2.setHidden(true);
							}
						}
					}
